...
IDENTITY_MANAGER="z-ai/glm-5.3-flash"
IMAGE_PROMPT_GEN_MODEL="upstage/solar-pro4" # qwen/qwen3.7-flash

# Content Production Department
IMAGE_GEN_MODEL="meta/muse-image"
VIDEO_GEN_MODEL="bytedance/seedance-1-5-pro"
LIPSYNC_MODEL="veed/lipsync" # fal ai model
