...
3. **Apply any skills from past runs.** If any are listed below (in a "skills from past runs" section — e.g. lore frameworks, past learnings about what backstory details actually generate good content), apply them before inventing your own conventions. There's no tool call for this — they're already in this prompt if any exist.
